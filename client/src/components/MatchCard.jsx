...
//   return (
//     <>
//       <div className="bg-white border border-slate-200 rounded-[32px] shadow-sm overflow-hidden max-w-5xl mx-auto hover:shadow-lg transition-all duration-300">
...
//               <span className="bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 shadow-sm">
...
//                 {/* ONLINE BADGE */}
//                 {/* <span className="absolute bottom-1 right-1 w-5 h-5 rounded-full bg-green-500 border-[3px] border-white"></span> */}
//               </div>
...
//                   <FaBookOpen className="text-green-800 text-lg" />
//                 </div>
...
//                   <FaGraduationCap className="text-violet-800 text-lg" />
//                 </div>
...
//             🔒 Contact details stay private until you start a conversation.
//           </p>
//         </div>
//       </div>
...
const MatchCard = ({ user }) => {
  ...
  return (
    <>
      <div className="bg-white border border-slate-200 rounded-[32px] shadow-sm overflow-hidden max-w-5xl mx-auto hover:shadow-lg transition-all duration-300 relative">
